...
namespace OnlineStore.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        //    if (order == null)
        //    {
        //        return NotFound(new { message = "Khong ton tai id nay." });
        //    }
        //    var user = GetUser(order.UserId);
        //    order.user = user;
        //    var response = _mapper.Map<OrderResponse>(order);
        //    response.Id = order.Id;
        //    response.CustomerId = order.user.Id;
        //    response.CustomerName = order.user.Username;
        //    response.AddressShipping = order.user.Address;
        //    response.OrderDate = order.OrderDate;
        //    response.OrderStatus = order.OrderStatus;
        ...
        [Authorize(Role.User)]
        [HttpGet("{userid}")]
        public ActionResult<IEnumerable<OrderResponse>> GetOrderUser(int userid)
        {
            ...
            foreach (var item in orders)
            {
                ...
                response.AddressShipping = item.user.Address;
        ...
        private void PostOrderDetail(int orderid)
        {
            ...
            foreach (var item in carts)
            {
                ...
                orderdetail.AddressShipping = item.user.Address;
